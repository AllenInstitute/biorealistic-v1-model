...
PERTURBATIONS: Sequence[DatasetSpec] = (
    DatasetSpec(
        ...
        target_nodes_file="low_outgoing_exc_core_nodes.json",
    ),
    DatasetSpec(
        "exc_high_core_neg1000",
        "Exc High\nSilencing",
        "OSI_DSI_DF_exc_high_core_neg1000.csv",
        target_nodes_file="high_outgoing_exc_core_nodes.json",
    ),
    DatasetSpec(
        "inh_low_core_neg1000",
        "Inh Low\nSilencing",
        "OSI_DSI_DF_inh_low_core_neg1000.csv",
        target_nodes_file="low_outgoing_inh_core_nodes.json",
    ),
    DatasetSpec(
        "inh_high_core_neg1000",
        "Inh High\nSilencing",
        "OSI_DSI_DF_inh_high_core_neg1000.csv",
        target_nodes_file="high_outgoing_inh_core_nodes.json",
    ),
)
...
def main() -> None:
    ...
    for metric in METRICS:
        ...
        plot_heatmap(
            ...
            metric,
            title,
            OUTPUT_DIR / f"silencing_heatmap_{metric}.png",
        )
