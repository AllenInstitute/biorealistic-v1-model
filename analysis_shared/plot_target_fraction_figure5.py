...
The actual entrypoint has moved to figure_scripts/figure5/plot_target_fraction_figure5.py.
...
NEW_SCRIPT = ROOT / "figure_scripts" / "figure5" / "plot_target_fraction_figure5.py"
