...
# biophys_ps_eV_values = np.array(biophys_ps_expVar)[
#     np.array([b != None for b in biophys_ps_expVar])
# ]  # get rid of 'None'
# print(
#     "total Biophysical - perisomatic with explained variance value:",
#     len(biophys_ps_eV_values),
#     ", mean:",
#     np.mean(biophys_ps_eV_values),
#     ", median:",
#     np.median(biophys_ps_eV_values),
# )
...
# biophys_aa_eV_values = np.array(biophys_aa_expVar)[
#     np.array([b != None for b in biophys_aa_expVar])
# ]  # get rid of 'None'
# print(
#     "total Biophysical - all active with explained variance value:",
#     len(biophys_aa_eV_values),
#     ", mean:",
#     np.mean(biophys_aa_eV_values),
#     ", median:",
#     np.median(biophys_aa_eV_values),
# )
