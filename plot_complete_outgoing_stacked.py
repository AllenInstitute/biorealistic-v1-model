...
The actual entrypoint has moved to figure_scripts/figure5/plot_complete_outgoing_stacked.py.
...
NEW_SCRIPT = ROOT / "figure_scripts" / "figure5" / "plot_complete_outgoing_stacked.py"
